...
$id=$_GET['id'];
$stmt =$conn->prepare("SELECT * FROM team_member_details WHERE member_id=$id");
$stmt->execute();
...
try{
	// if(isset($date1))
	// {
		$stmt2=$conn->prepare("UPDATE `team_member_details` SET `member_name`=:member_name,`position`=:position,`image`=:image,`status`=:status ,`education`=:education WHERE member_id=$id");	
		$executed=$stmt2->execute(array(':image' => $date1,':member_name' => $member_name,':position' => $position,':education' => $education , ':status' => $status));
    if ($executed) {
     echo "<script>alert('Updated Successfully....');window.location.href='member_list';</script>";
    }
	  /*}
	   else
	   {
                  ...
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="" class="form-control col-md-7 col-xs-12" type="text" name="member_name" required="required" placeholder="Enter Member Name"  value="<?php echo $row[0]['member_name']; ?>">
                      </div>
                    </div>
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="" class="form-control col-md-7 col-xs-12" type="text" name="education" required="required" placeholder="Ex: Btech,Bsc,Mtech,etc..." value="<?php echo $row[0]['education']; ?>">
                      </div>
                    </div>
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="" class="form-control col-md-7 col-xs-12" type="text" name="position" required="required" placeholder="Ex: Founder,Cheaf,Co-founde,etc...." value="<?php echo $row[0]['position']; ?>">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <img src="images/team_member/<?php echo $row[0]['image']; ?>" style="width:100px;height:100px;">
                      </div>
                    </div> 
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="" class=" col-md-7 col-xs-12" type="file" name="image">
