...
if(isset($_GET['del_id']))
	{		
  $del_id=$_GET['del_id'];	
   $stmt=$conn->prepare("DELETE FROM franchise_from WHERE franchise_id=$del_id");	
	$stmt->execute();	}
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content"> 
				<?php
				$stmt=$conn->prepare("SELECT * FROM franchise_from ");
				$stmt->execute();
            ...
            <td><?php echo $row[$i]['mob_no']; ?></td>
						<td><?php echo $row[$i]['address']; ?></td>
            <td><?php echo $row[$i]['added_on']; ?></td>
						<td><a href="franchise_list?del_id=<?php echo $row[$i]['franchise_id']; ?>"><button>Delete</button></a></td>	
                      </tr>
					<?php
					}
					?>
