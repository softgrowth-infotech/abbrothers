...
if(isset($_POST['submit']))
{
	extract($_POST);
// Start actual image
   $targetDir = "image/properties_img/"; 
    ...
    $fileNames = array_filter($_FILES['image']['name']); 
      ...
      $date1=$arr1[0]."_".date('dmYhis').".$extension1";
            ...
            if(in_array($fileType, $allowTypes)){ 
                ...
                if(move_uploaded_file($_FILES["image"]["tmp_name"][$key], "images/gallery/".$date1)){ 
                    // Image db insert sql 
                    //code to add image to database image table

          $stmt = $conn->prepare("INSERT INTO `gallery`(`image`,`status`)VALUES(:image,:status)");
          $executed=$stmt->execute(array(':image' => $date1,':status' => $status));
               }else{ 
		...
		<div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <h5>Note:You Can Select The Multiple Images At Time.</h5>
                <div class="x_content">
                  <br />
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="" class=" col-md-7 col-xs-12" type="file" name="image[]" multiple required="required">
                      </div>
                    </div> 
