...
try{
		...
		$stmt2=$conn->prepare("UPDATE `category_menu` SET 
...
$stmt =$conn->prepare("SELECT * FROM category_menu WHERE menu_id=$id");
$stmt->execute();
                  ...
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="" enctype="multipart/form-data">
					...
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input  class=" col-md-7 col-xs-12 form-control" type="text" name="category_name" value="<?php echo $row[0]['category_name']; ?>" placeholder="Enter Room Details">
                      </div>
                    </div>
